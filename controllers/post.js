...
export const getPosts = (req, res) => {
    ...
    jwt.verify(token, process.env.JWT_TOKEN.toString(), (err, userInfo) => {
        ...
        const q = userId
            ...
            :
            `SELECT p.*, u.id AS userId, name, profilePic FROM POSTS AS p JOIN users AS u ON (u.id = p.userId)
        LEFT JOIN relationships AS r ON (p.userId = r.followedUserId) WHERE r.followedUserId = ? OR p.userId = ?
